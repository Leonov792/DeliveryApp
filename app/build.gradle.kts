...
android {
    namespace = "com.example.delivery"; compileSdk = 34
    defaultConfig { applicationId = "com.example.delivery"; minSdk = 24; targetSdk = 34; versionCode = 1; versionName = "1.0" }
...
dependencies {
    ...
    implementation("com.google.android.gms:play-services-maps:18.2.0"); implementation("com.google.android.gms:play-services-location:21.0.1")
}
